resource "azurerm_sentinel_alert_rule_scheduled" "potential_raspberry_robin_dot_ending_file" {
  name                       = "potential_raspberry_robin_dot_ending_file"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Potential Raspberry Robin Dot Ending File"
