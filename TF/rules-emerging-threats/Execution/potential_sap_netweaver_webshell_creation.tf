resource "azurerm_sentinel_alert_rule_scheduled" "potential_sap_netweaver_webshell_creation" {
  name                       = "potential_sap_netweaver_webshell_creation"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Potential SAP NetWeaver Webshell Creation"
