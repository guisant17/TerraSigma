resource "azurerm_sentinel_alert_rule_scheduled" "blackbyte_ransomware_registry" {
  name                       = "blackbyte_ransomware_registry"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Blackbyte Ransomware Registry"
