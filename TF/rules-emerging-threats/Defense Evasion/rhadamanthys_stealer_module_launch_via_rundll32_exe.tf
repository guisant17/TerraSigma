resource "azurerm_sentinel_alert_rule_scheduled" "rhadamanthys_stealer_module_launch_via_rundll32_exe" {
  name                       = "rhadamanthys_stealer_module_launch_via_rundll32_exe"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Rhadamanthys Stealer Module Launch Via Rundll32.EXE"
