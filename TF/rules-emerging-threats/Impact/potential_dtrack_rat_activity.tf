resource "azurerm_sentinel_alert_rule_scheduled" "potential_dtrack_rat_activity" {
  name                       = "potential_dtrack_rat_activity"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Potential Dtrack RAT Activity"
